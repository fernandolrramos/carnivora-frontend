...
function App() {
  ...
  // ✅ Prevent auto-scrolling while user is typing
  useEffect(() => {
  ...
  return (
    <div style={{
      ...
      height: "100vh", minHeight: "100vh", maxWidth: "600px", margin: "auto",
      ...
      <div style={{
        ...
        borderRadius: "5px", display: "flex", flexDirection: "column", padding: "10px"
      }}>
      ...
      <div style={{
        ...
        bottom: 0, background: "#f4f4f4", width: "100%"
      }}>
        <input
          type="text"
          value={input}
